function configure_eth() {
    ...
    ip "$net_param" a add "$1" dev enp0s3
}
...
case ${2} in
  "IPV4")
    hosts=("" "7.8.1.2/30" "7.8.2.2/30" "7.8.1.1/30" "7.8.3.2/30")
    net_param=""
    ;;
  "IPV6")
    hosts=("" "::ffff:0708:0102/126" "::ffff:0708:0202/126" "::ffff:0708:0101/126" "::ffff:0708:0302/126")
    net_param="-6"
    ;;
  *)
